 ...
 * Wouter: As I understand it this is a way to access fields in a view, editpane or textarea.
 * It is used via jEdit.visit() which lets the visitor visit all the Views in the editor.
 * 
