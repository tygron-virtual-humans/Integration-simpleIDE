...
{
	//{{{ getFirstFile() method
	public String getFirstFile(ViewInterface view)
	{
		return view.getBuffer().getPath();
	} //}}}

	//{{{ getNextFile() method
	public String getNextFile(ViewInterface view, String file)
	{
		if(file == null)
			return view.getBuffer().getPath();
		else
	...
	//{{{ getFiles() method
	public String[] getFiles(ViewInterface view)
	{
		return new String[] { view.getBuffer().getPath() };
	} //}}}

	//{{{ getFileCount() method
	public int getFileCount(ViewInterface view)
	{
		return 1;
	} //}}}
