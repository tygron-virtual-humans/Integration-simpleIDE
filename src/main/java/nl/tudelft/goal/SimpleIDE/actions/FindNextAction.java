...
/**
 * Search next occurence of text that was given earlier in the find dialog.
 *
 * @author W.Pasman 20jun2011
 */
@SuppressWarnings("serial")
public class FindNextAction extends GOALAction {

	/**
	 *
	 */
	private static final long serialVersionUID = -8440215015179023195L;
	...
	protected void execute(IDENode selectedNode, ActionEvent ae)
		...
		EditManager.getInstance().findNext();
	}
}
