...
import nl.tudelft.goal.SimpleIDE.menu.MemInfoBox;
...
public class MemStatsAction extends GOALAction {
	 ...
	 *
	 */
	private static final long serialVersionUID = 7678442898779361554L;
	...
	protected void execute(IDENode selectedNode, ActionEvent ae)
		...
		new MemInfoBox(developmentEnvironment.getMainPanel());
	}
}
