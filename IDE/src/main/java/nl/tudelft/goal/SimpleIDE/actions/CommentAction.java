...
/**
 * Ask current editor to comment out the selected text.
 *
 * @author W.Pasman 20jun2011
 */
public class CommentAction extends GOALAction {
	/**
	 *
	 */
	private static final long serialVersionUID = 4458446968372846204L;
	...
	protected void execute(IDENode selectedNode, ActionEvent ae)
		...
		EditManager.getInstance().comment();
	}
}
