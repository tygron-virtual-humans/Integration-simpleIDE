...
/**
 * Ask current editor to paste contents at current cursor location/selection.
 *
...
public class PasteAction extends GOALAction {
	 ...
	 *
	 */
	private static final long serialVersionUID = -4554040824812327525L;

	public PasteAction() {
		setIcon(IconFactory.PASTE_TEXT.getIcon());
		setShortcut('V');
		setDescription("replace selection with clipboard text");
	}
