...
/**
 * Ask current editor to un-comment (remove comment marks from) the selected
 * text.
 *
 * @author W.Pasman 20jun2011
 */
@SuppressWarnings("serial")
public class UnCommentAction extends GOALAction {

	/**
	 *
	 */
	private static final long serialVersionUID = 1014343402441446229L;
	...
	protected void execute(IDENode selectedNode, ActionEvent ae)
		...
		EditManager.getInstance().uncomment();
	}
}
