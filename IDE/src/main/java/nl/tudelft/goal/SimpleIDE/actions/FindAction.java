...
/**
 * Find action : search for string in the open text editor.
 *
 * @author W.Pasman 20jun2011
 */
@SuppressWarnings("serial")
public class FindAction extends GOALAction {

	/**
	 *
	 */
	private static final long serialVersionUID = 3099165361972705979L;
	...
	protected void execute(IDENode selectedNode, ActionEvent ae)
		...
		EditManager.getInstance().searchReplace();
	}
}
